...
![résultat de l'état du moteur de recherche Elasticsearch](documentation/files/installation-local-resultat-elasticsearch.png)
...
![résultat du service /R4/ResearchStudy sur swagger](documentation/files/installation-local-resultat-swagger.png)
...
- Les données implémentées sont marquées par une coche sur l'image [mapping.png](documentation/files/mapping.png)
