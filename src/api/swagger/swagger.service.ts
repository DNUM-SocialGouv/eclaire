...
export class SwaggerService {
  create(app: NestExpressApplication) {
    const builder = new DocumentBuilder()
      ...
      .setDescription(`<p>Base nationale des essais cliniques au standard <a href="https://hl7.org/fhir/R4/index.html" target="_blank"><abbr title="Fast Healthcare Interoperability Resources">FHIR</abbr></a>.</p>
        ...
        <p>Si vous avez des demandes d'améliorations ou des bugs, vous pouvez écrire une <a href="https://github.com/DNUM-SocialGouv/eclaire/issues" target="_blank">issue</a> sur notre Github.</p>
