...
describe('#FindGroupController - e2e', async () => {
  ...
  it('should retrieve one group', async () => {
    ...
    expect(response.text).toMatchInlineSnapshot('"{"actual":true,"characteristic":[{"exclude":false,"valueCodeableConcept":{"coding":[{"code":"male","display":"Male","system":"http://hl7.org/fhir/administrative-gender","version":"5.0.0"},{"code":"female","display":"Female","system":"http://hl7.org/fhir/administrative-gender","version":"5.0.0"}]}},{"exclude":false,"valueRange":{"low":{"unit":"years","value":65}}},{"exclude":false,"valueRange":{"high":{"unit":"years","value":64},"low":{"unit":"years","value":18}}},{"exclude":false,"valueCodeableConcept":{"coding":[{"display":"Données non disponible"}]}},{"exclude":false,"valueCodeableConcept":{"coding":[{"code":"no-using-contraception","display":"Women of child bearing potential not using contraception (Femmes en âge de procréer n\'utilisant pas de contraception)","system":"https://interop.esante.gouv.fr/ig/fhir/eclaire/CodeSystem/eclaire-study-population-code-system","version":"0.2.0"},{"code":"using-contraception","display":"Women of child bearing potential using contraception (Femmes en âge de procréer utilisant une méthode de contraception)","system":"https://interop.esante.gouv.fr/ig/fhir/eclaire/CodeSystem/eclaire-study-population-code-system","version":"0.2.0"}]}},{"exclude":false,"valueCodeableConcept":{"coding":[{"display":"INDISPONIBLE"}]}},{"exclude":true,"valueCodeableConcept":{"coding":[{"display":"INDISPONIBLE"}]}}],"id":"2022-500014-26-00-enrollment-group","quantity":21,"type":"person","resourceType":"Group"}"')
  })
