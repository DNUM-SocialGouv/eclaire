...
import { NextcloudService } from '../../../etl/nextcloud/NextcloudService'
...
export class DownloadFileController {
  constructor(
    ...
    private readonly etlService: EtlService, // Service to generate the file
    private readonly service: NextcloudService
  ) { }

  @Get('check')
  async testConnectionNextcloud() {
  ...
  async download() {
    return this.service.downloadFile(
      'Frog.jpg',          // fichier dans Nextcloud
      'frog-local.jpg',    // fichier local
    );
  }
